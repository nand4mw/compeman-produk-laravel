...
<!-- Mirrored from templates.hibootstrap.com/farol/logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 07:17:34 GMT -->
<head>
...
<div class="m-auto m-510 w-sm-100 py-5">
<form>
...
<img src="assets/images/coffee.svg" class="mb-4" alt="coffee">
<h4 class="fs-20 fw-semibold mb-2">You are Logged Out</h4>
<p class="mb-4">Thank you for using <strong>Farol</strong> admin template</p>
<a href="login.html" class="btn btn-primary fs-16 fw-semibold text-dark heading-fornt py-2 py-md-3 px-4 text-white w-100">
Login
</a>
</div>
</div>
